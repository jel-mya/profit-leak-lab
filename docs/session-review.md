...
6. Save recovery form edits before filtering or navigating away from the card. Expand recovery history to inspect the latest five revisions; download actions for all saved revisions and import-version metadata. The download includes every action regardless of the current filter.
